...
class CategoryService:
    ...
    def get_all_categories(self) -> List[CategoryResponse]:
        categories = self.repository.get_all() # получение инфы их базы
        return [CategoryResponse.model_validate(cat) for cat in categories] # валидация и вывод инфы в формате ответа
